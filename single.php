<?php 
    ...
    while(have_posts()):the_post();
        ...
        if (get_post_type() == "fire_product" || get_post_type() == "fire_news" || get_post_type() == "fire_cases"):
        {?>
            ...
            <?php
                ...
                if($length != null):
                    for($i = 0; $i < $length ;$i++):
                        ...
                        $arr = ['i'=>$i, 'type' => $type, 'order' => $order ,'ptype' => $ptype];
                        ...
                        switch($type):
                            ...
                            case 'ctaB':
                                get_template_part('includes/section','ctaB');
                                 break;
                                 case 'html':
                                    get_template_part('includes/section','html');
                                    break;
                            case 'features':
                                                                        ...
                                                                        case 'twoSec':
                                                                            ...
                                                                            case 'inspire':
                                                                                ...
                                                                                case 'infoPriser':
                                                                                    ...
                                                                                    break;
                                                                                    case 'productSpec':
                                                                                        get_template_part('includes/section','product'); 
                                                                                        break;
                                                                                        case 'tabbed':
                                                                                            get_template_part('includes/section','tabbed'); 
                                                                                            break;
                                                                                            case 'sameInfo':
                                                                                                get_template_part('includes/section','sameInfo'); 
                                                                                            break;
                                                                                            case 'gridShow':
                                                                                                get_template_part('includes/section','newsRow'); 
                                                                                            break;
                            default:
                                break;
                        endswitch;
